...
const SPLITTER_ID = registry.register({
  ...
  system_prompt: [
    ...
    'You MUST save your output by calling save_to_memory with key "topics" containing a JSON array of sub-topic strings.',
    'Example: save_to_memory({ key: "topics", value: ["Sub-topic 1", "Sub-topic 2", "Sub-topic 3", "Sub-topic 4"] })',
    'Output ONLY the save_to_memory call, no other text.',
  ].join(' '),
  temperature: 0.5,
  max_steps: 3,
  tools: [],
...
const RESEARCHER_ID = registry.register({
  ...
  system_prompt: [
    ...
    'You MUST save your output by calling save_to_memory with key "research" containing your notes as a string.',
  ].join(' '),
  temperature: 0.5,
  max_steps: 3,
  tools: [],
...
const SYNTHESIZER_ID = registry.register({
  ...
  system_prompt: [
    ...
    'You MUST save your output by calling save_to_memory with key "summary" containing the unified summary.',
  ].join(' '),
  temperature: 0.4,
  max_steps: 3,
  tools: [],
